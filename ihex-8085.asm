...
;;;
;;; Transmit 0-terminated string on serial port
;;;
txstr:
	mov a,m
	cpi 00h
...
;;;
;;; Receive character on serial port
;;; Result: A
;;;
rxchar:
	push b
...
;;;
;;; Transmit character on serial port
;;; Input: A
;;;
txchar:
	push d
...
;;;
;;; Delay functions for serial port bit timings
;;;
delay_baud_a:
	push psw
	push h
	lhld baud_a
	jmp delay_baud_common
delay_baud_b:
	push psw
	push h
	lhld baud_b
